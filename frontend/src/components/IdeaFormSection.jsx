    ...
    <section className="idea-form-section">
      <div className="voting-section" tabIndex="0">
        ...
        <ul className="idea-list">
          <li className="idea-item">
            ...
            <div className="vote-controls">
              <button className="image-only-upvote-button">
                <img src="https://i.ibb.co/DfxLPp7g/Upvote-transparent-2.png" alt="Upvote" className="upvote-icon" />
              </button>
          ...
          <li className="idea-item">
            <span className="idea-text">Integrate with Slack for notifications</span>
            <div className="vote-controls">
              <button className="image-only-upvote-button">
                <img src="https://i.ibb.co/DfxLPp7g/Upvote-transparent-2.png" alt="Upvote" className="upvote-icon" />
              </button>
