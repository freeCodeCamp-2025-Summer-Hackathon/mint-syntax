...
export default function ForgotPassword() {
  return (
    <div className="max-w-md mx-auto mt-16 p-6 bg-[#f4fdf9] rounded-lg shadow-lg border border-[#cdeee3]">
      <h1 className="text-2xl font-bold mb-4 text-center text-[#317c67]">🔒 Forgot your password?</h1>
      ...
      <form>
        <input
          ...
          required
        />
        <button className="btn w-full bg-[#5dc394] hover:bg-[#49ab7f] text-white" type="submit">
          Send reset link
        </button>
      </form>
